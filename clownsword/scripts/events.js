...
AudioEvents.addEvent('addClipToFileWindow', function(clip_path, clip_title) {
    ...
    document.getElementById('file').innerHTML += '<div class="trackListContainer"><span class="trackListAdd" onclick="AudioEvents.fireEvent(\'createNewTrackFromClip\', [\'' + clip_path + '\'])"><a href="#" class="">+</a></span><span class="trackListName" draggable="true">' + clip_title + '</span></div>';
});
