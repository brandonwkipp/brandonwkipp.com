                    ...
                    collection.loadFromProject(currentProject, function(tempCollection) {
                        ...
                        collection.loadAll(function(t) {
                            ...
                            if(loadedCount == collection.tracks.length)
                            {
                                ...
                                {
                                    loadSave('Initializing SoundSword', 'Generating UI for track ' + j + '...');
    ...
    <div id="logoContainer">
  	...
  	<div id="timekeeping">
  		<div id="timeContainer">
  			<div class="rows">
  				<button id="countOff" onclick="countOffOn()">Count Off</button>
...
<div id="fileWindow">
    ...
    <div id="file">
        ...
        else
        {
            ...
            {
                echo '<div class="trackListContainer"><span class="trackListAdd" onclick="AudioEvents.fireEvent(\'createNewTrackFromClip\', [\'' . $track['path'] . '\'])"><a href="#" class="noSelect">+</a></span><span class="trackListName" draggable="true">' . $track['title'] . '</span></div>';
            }
        }
        ?>
    </div>
...
<div id="trackEditWindow">
	...
	<div id="edit" onscroll="scrollTest()">
        <div id="timelines">
